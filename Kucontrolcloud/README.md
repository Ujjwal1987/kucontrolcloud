...
Now you can run KuControl by the following command:
```
sudo node app.js
```
...
We now need to setup a virtual server to install and run the KuControl application on the node.
...
You are ready to start the KuControl service.
